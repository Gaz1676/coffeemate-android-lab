        ...
        AbsListView.MultiChoiceModeListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listAdapter = new CoffeeListAdapter(getActivity(), this, Base.app.dbManager.getAll());
    ...
    public void onResume() {
        ...
        if(activity.app.dbManager.getAll().isEmpty())
    ...
    public void onCoffeeDelete(final Coffee coffee)
    {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener()
        {
            ...
            {
                Base.app.dbManager.delete(coffee.coffeeId); // remove from our database
